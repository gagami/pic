#!/bin/bash
# ==========================================================
# Watchtower Monitor 安装脚本（修正版，挂载日志目录）
# ==========================================================
